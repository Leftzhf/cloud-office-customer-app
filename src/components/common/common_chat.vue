    ...
    <div class="common_chat-inner">
                      ...
                      <div class="file-info">
                        ...
                        <div class="file-opr">
                          <div v-show="item.state=='success'">
                            <a class="file-download" :href="item.fileUrl" target="_blank" :download="item.fileUrl"
                            >下载</a>
                          </div>
                        </div>
                      </div>
      ...
      <div class="common_chat-footer">
        <div>
          ...
          <!-- 发送按钮 -->
          <el-button type="primary" size="small" class="send-btn" :class="chatInfoEn.state" @click="sendText()"
